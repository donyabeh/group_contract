...
Plot the distribution of the R2 values from the regressions. Discuss the implications of the values shown in this plot. How well does your model generate data similar to what was observed?
    ...
    Present visuals of simulated data (alongside observed data) and discuss similarities and/or differences.
    Present R2  distribution plot and discuss implications.

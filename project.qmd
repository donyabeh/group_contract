...
Predicted life expectancy = 40.113 + 0.587 * (Average happiness score)
...
sim_reg_p <- sim_data |>
  ...
  labs(x = "Average Happiness Score",
       ...
       title = "Simulated Averate Life Expectancy\nbased on Regression Model")
...
obs_reg_p <- hap_lex_updated |>
  ...
  labs(x = "Average Happiness Score",
       y = "",
       subtitle = "Average Life Expectancy (Years)",
       title = "Observed Average Life Expectancy")

grid.arrange(obs_reg_p, sim_reg_p, ncol=2)

# plot 2 plots side by side: https://stackoverflow.com/questions/1249548/side-by-side-plots-with-ggplot2
```
<<<<<<< HEAD
